<?php /* Smarty version 2.6.18, created on 2017-01-30 17:55:59
         compiled from /opt/lampp/htdocs/www/formtools/modules/pages/templates/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'clients_dropdown', '/opt/lampp/htdocs/www/formtools/modules/pages/templates/add.tpl', 109, false),array('modifier', 'upper', '/opt/lampp/htdocs/www/formtools/modules/pages/templates/add.tpl', 136, false),)), $this); ?>
 ...
 ?>
  ...
  <tr>
    ...
    <td class="title">
      ...
      <span class="joiner">&raquo;</span>
      <?php echo $this->_tpl_vars['L']['phrase_add_page']; ?>
...
/global/codemirror/js/"
        ...
        <?php if ($this->_tpl_vars['tinymce_available'] == 'yes'): ?>
 ...
 <span class="light_grey"><?php echo $this->_tpl_vars['LANG']['phrase_only_specific_clients_have_access']; ?>
      	...
      	<div id="custom_clients" class="margin_top" style="display:none">
      	  ...
      	  <tr>
      	    <td>
      	      <?php echo smarty_function_clients_dropdown(array('name_id' => "available_client_ids[]",'multiple' => 'true','multiple_action' => 'hide','clients' => $this->_tpl_vars['page_info']['clients'],'size' => '4','style' => "width: 240px"), $this);?>
...
"
      	    ...
      	    <td>
      	      <?php echo smarty_function_clients_dropdown(array('name_id' => "selected_client_ids[]",'multiple' => 'true','multiple_action' => 'show','clients' => $this->_tpl_vars['page_info']['clients'],'size' => '4','style' => "width: 240px"), $this);?>
    ...
    <p>
      <input type="submit" name="add_page" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['LANG']['word_update'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
" />
    </p>
