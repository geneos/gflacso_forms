<?php /* Smarty version 2.6.18, created on 2017-01-30 16:41:24
         compiled from /opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 118, false),array('modifier', 'count', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 157, false),array('modifier', 'escape', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 169, false),array('function', 'views_dropdown', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 122, false),array('function', 'template_sets', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 126, false),array('function', 'display_template_set_templates', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 150, false),array('function', 'display_template_set_placeholders', '/opt/lampp/htdocs/www/formtools/modules/form_builder/templates/preview.tpl', 161, false),)), $this); ?>
<!doctype html>
<html>
<head>
  <title><?php echo $this->_tpl_vars['L']['module_name']; ?>
</title>
  <link type="text/css" rel="stylesheet" href="<?php echo $this->_tpl_vars['g_root_url']; ?>
/modules/form_builder/global/css/builder.css">
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/global/scripts/jquery.js"></script>
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/themes/default/scripts/jquery-ui-1.8.6.custom.min.js"></script>
  <link href="<?php echo $this->_tpl_vars['g_root_url']; ?>
/themes/default/css/smoothness/jquery-ui-1.8.6.custom.css" rel="stylesheet" type="text/css"/>
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/global/scripts/general.js"></script>
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/global/scripts/jquery-ui-timepicker-addon.js"></script>
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/modules/form_builder/global/scripts/builder.js"></script>
  <script src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/global/codemirror/js/codemirror.js"></script>
  <script>
  <?php echo '
  var g = {
...
";
  g.sidebar_width = <?php echo $this->_tpl_vars['sidebar_width']; ?>
;
  g.header_height = <?php echo $this->_tpl_vars['header_height']; ?>
;
  g.footer_height = <?php echo $this->_tpl_vars['footer_height']; ?>
;
  g.iframe_header_height = <?php echo $this->_tpl_vars['iframe_header_height']; ?>
;
  g.demo_mode = <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>true<?php else: ?>false<?php endif; ?>;
  g.messages = <?php echo '{'; ?>

    word_cancel: "<?php echo $this->_tpl_vars['LANG']['word_cancel']; ?>
",
    word_update: "<?php echo $this->_tpl_vars['LANG']['word_update']; ?>
",
    word_help: "<?php echo $this->_tpl_vars['LANG']['word_help']; ?>
",
    word_review: "<?php echo $this->_tpl_vars['L']['word_review']; ?>
",
    word_thanks: "<?php echo $this->_tpl_vars['L']['word_thanks']; ?>
",
    word_close: "<?php echo $this->_tpl_vars['LANG']['word_close']; ?>
",
    word_saved: "<?php echo $this->_tpl_vars['L']['word_saved']; ?>
",
    word_loading_p: "<?php echo $this->_tpl_vars['L']['word_loading_p']; ?>
",
    word_publish: "<?php echo $this->_tpl_vars['L']['word_publish']; ?>
",
    phrase_thankyou_page_content: "<?php echo $this->_tpl_vars['L']['phrase_thankyou_page_content']; ?>
",
    phrase_form_offline_page_content: "<?php echo $this->_tpl_vars['L']['phrase_edit_form_offline_page_content']; ?>
",
    phrase_hide_sidebar: "<?php echo $this->_tpl_vars['L']['phrase_hide_sidebar']; ?>
",
    phrase_show_sidebar: "<?php echo $this->_tpl_vars['L']['phrase_show_sidebar']; ?>
",
    phrase_update_and_show: "<?php echo $this->_tpl_vars['L']['phrase_update_and_show']; ?>
",
    phrase_close_window: "<?php echo $this->_tpl_vars['L']['phrase_close_window']; ?>
",
    phrase_return_to_form_builder: "<?php echo $this->_tpl_vars['L']['phrase_return_to_form_builder']; ?>
",
    phrase_form_offline_page: "<?php echo $this->_tpl_vars['L']['phrase_form_offline_page']; ?>
",
    phrase_publish_form: "<?php echo $this->_tpl_vars['L']['phrase_publish_form']; ?>
",
    phrase_open_form_in_new_window: "<?php echo $this->_tpl_vars['L']['phrase_open_form_in_new_window']; ?>
",
    phrase_publish_settings: "<?php echo $this->_tpl_vars['L']['phrase_publish_settings']; ?>
",
    notify_form_config_saved: "<?php echo $this->_tpl_vars['L']['notify_form_config_saved']; ?>
",
    notify_form_published: "<?php echo $this->_tpl_vars['L']['notify_form_published']; ?>
",
    notify_form_republished: "<?php echo $this->_tpl_vars['L']['notify_form_republished']; ?>
",
    validation_no_filename: "<?php echo $this->_tpl_vars['L']['validation_no_filename']; ?>
",
    validation_filename_not_alpha: "<?php echo $this->_tpl_vars['L']['validation_filename_not_alpha']; ?>
",
    validation_no_folder_url: "<?php echo $this->_tpl_vars['L']['validation_no_folder_url']; ?>
",
    validation_no_folder_path: "<?php echo $this->_tpl_vars['L']['validation_no_folder_path']; ?>
",
    validation_no_publish_setting_changes: "<?php echo $this->_tpl_vars['L']['validation_no_publish_setting_changes']; ?>
"
  <?php echo '}'; ?>

  g.loading = new Image();
  g.loading.src = "<?php echo $this->_tpl_vars['g_root_url']; ?>
/modules/form_builder/images/sidebar_section_loading.gif";
  ...
  #header <?php echo '{'; ?>
    ...
    height: <?php echo $this->_tpl_vars['header_height']; ?>
px;
  <?php echo '}'; ?>

  #footer <?php echo '{'; ?>

    height: <?php echo $this->_tpl_vars['footer_height']; ?>
px;
  <?php echo '}'; ?>

  #sidebar <?php echo '{'; ?>

    width: <?php echo $this->_tpl_vars['sidebar_width']; ?>
px;
    height: <?php echo $this->_tpl_vars['content_height']; ?>
px;
    top: <?php echo $this->_tpl_vars['header_height']; ?>
px;
  <?php echo '}'; ?>

  #preview_iframe <?php echo '{'; ?>

    left: <?php echo $this->_tpl_vars['sidebar_width']; ?>
px;
    top: <?php echo $this->_tpl_vars['iframe_header_height']+$this->_tpl_vars['header_height']; ?>
px;
    height: <?php echo $this->_tpl_vars['content_height']-$this->_tpl_vars['iframe_header']; ?>
px;
    width: <?php echo $this->_tpl_vars['iframe_width']; ?>
px;
  <?php echo '}'; ?>

  #iframe_header <?php echo '{'; ?>

    left: <?php echo $this->_tpl_vars['sidebar_width']; ?>
px;
    height: <?php echo $this->_tpl_vars['iframe_header_height']; ?>
px;
    width: <?php echo $this->_tpl_vars['iframe_width']; ?>
px;
  <?php echo '}'; ?>
...
<?php if ($this->_tpl_vars['major_error']): ?>

  <div id="header">
    <h1><?php echo $this->_tpl_vars['L']['module_name']; ?>
</h1>
  </div>
  <div class="clear"></div>
  <div id="major_error">
    <div>
      <?php echo $this->_tpl_vars['major_error']; ?>

    </div>
    <span class="close"><?php echo $this->_tpl_vars['L']['phrase_close_window']; ?>
</span>
    <span class="goto_form_builder"><?php echo $this->_tpl_vars['L']['phrase_go_to_form_builder']; ?>
</span>
  </div>
...
<?php else: ?>
  ...
  <div id="header">
    ...
    <div id="publish_url" <?php if ($this->_tpl_vars['is_published'] == 'no'): ?>class="hidden"<?php endif; ?>>
      <a href="<?php echo $this->_tpl_vars['published_folder_url']; ?>
/<?php echo $this->_tpl_vars['published_filename']; ?>
.php" target="_blank"><?php echo $this->_tpl_vars['published_folder_url']; ?>
/<?php echo $this->_tpl_vars['published_filename']; ?>
.php</a>
    </div>
  </div>
  <div id="sidebar">
    <form action="preview_form.php" id="f" method="post" target="preview_iframe">
      <input type="hidden" name="published_form_id" id="published_form_id" value="<?php echo $this->_tpl_vars['published_form_id']; ?>
" />
...
" />
      ...
      <div class="section">
        <h2 id="main_settings_heading" class="first"><?php echo ((is_array($_tmp=$this->_tpl_vars['LANG']['phrase_main_settings'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</h2>
        <div class="section_options" id="main_settings">
          <div>
            <label for="view_id"><?php echo $this->_tpl_vars['LANG']['word_view']; ?>
</label>
            <?php echo smarty_function_views_dropdown(array('name_id' => 'view_id','form_id' => $this->_tpl_vars['form_id'],'selected' => $this->_tpl_vars['view_id'],'class' => 'full'), $this);?>

          </div>
          <div>
            <label for="template_set_id"><?php echo $this->_tpl_vars['L']['phrase_template_set']; ?>
</label>
            <div><?php echo smarty_function_template_sets(array('name_id' => 'template_set_id','default' => $this->_tpl_vars['set_id'],'class' => 'full'), $this);?>
</div>
          </div>
          <div>
            <input type="checkbox" name="is_online" id="is_online" <?php if ($this->_tpl_vars['is_online'] == 'yes'): ?>checked="checked"<?php endif; ?> />
            <label for="is_online"><?php echo $this->_tpl_vars['L']['phrase_form_is_online']; ?>
</label>
          </div>
          <div>
            <input type="checkbox" name="include_review_page" id="irp" <?php if ($this->_tpl_vars['include_review_page'] == 'yes'): ?>checked="checked"<?php endif; ?> />
            <label for="irp"><?php echo $this->_tpl_vars['L']['phrase_include_review_page']; ?>
</label>
          </div>
          <div>
            <input type="checkbox" name="include_thanks_page_in_nav" id="itpin" <?php if ($this->_tpl_vars['include_thanks_page_in_nav'] == 'yes'): ?>checked="checked"<?php endif; ?> />
            <label for="itpin"><?php echo $this->_tpl_vars['L']['phrase_include_thanks_page_in_nav']; ?>
</label>
          </div>
        </div>
      </div>
      ...
      <div class="section">
        <h2 id="template_settings_heading">
          <?php echo ((is_array($_tmp=$this->_tpl_vars['L']['word_templates'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>

          <span id="template_count">(<?php echo $this->_tpl_vars['num_configurable_templates']; ?>
)</span>
          <span class="section_loading"></span>
        </h2>
        <div class="section_options" id="template_settings" style="display:none">
          <?php echo smarty_function_display_template_set_templates(array('set_id' => $this->_tpl_vars['set_id'],'selected_templates' => $this->_tpl_vars['selected_templates']), $this);?>
      ...
      <div class="section">
        <h2 id="placeholders_heading">
          <?php echo ((is_array($_tmp=$this->_tpl_vars['L']['word_placeholders'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>

          <span id="placeholder_count">(<?php echo count($this->_tpl_vars['placeholders']); ?>
)</span>
          <span class="section_loading"></span>
        </h2>
        <div class="section_options" id="placeholders" style="display:none">
          <?php echo smarty_function_display_template_set_placeholders(array('set_id' => $this->_tpl_vars['set_id'],'placeholders' => $this->_tpl_vars['placeholders'],'placeholder_hash' => $this->_tpl_vars['placeholder_hash']), $this);?>

        </div>
      </div>

      <div class="section">
        <h2 id="thankyou_page_heading"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_thankyou_page_content'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</h2>
        <div id="thankyou_page" style="display:none">
          <textarea name="thankyou_page_content" id="thankyou_page_content"><?php echo ((is_array($_tmp=$this->_tpl_vars['thankyou_page_content'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea>
      ...
      <div class="section">
        <h2 id="form_offline_heading"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_form_offline_page_content'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</h2>
        <div id="form_offline" style="display:none">
          <textarea name="form_offline_page_content" class="monospace" id="form_offline_page_content"><?php echo ((is_array($_tmp=$this->_tpl_vars['form_offline_page_content'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea>
      ...
      <div class="section">
        <h2 id="advanced_heading"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_other_settings'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</h2>
        <div id="advanced" class="section_options" style="display:none">
          <div>
            <label for="fod"><?php echo $this->_tpl_vars['L']['phrase_automatically_take_form_offline_on_c']; ?>
</label>
            <div>
              <input type="text" name="offline_date" id="fod" size="18" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['offline_date'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
              <img class="ui-datepicker-trigger" src="<?php echo $this->_tpl_vars['g_root_url']; ?>
/global/images/calendar.png" id="fod_icon_id" />
              <span id="clear_offline_form"<?php if ($this->_tpl_vars['offline_date'] == ""): ?>style="display:none"<?php endif; ?>>clear</span>
            </div>
          </div>
          <div>
            <label for="rpt"><?php echo $this->_tpl_vars['L']['phrase_review_page_nav_title']; ?>
</label>
            <div><input type="text" name="review_page_title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['review_page_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" id="rpt" class="full" /></div>
          </div>
          <div>
            <label for="tpt"><?php echo $this->_tpl_vars['L']['phrase_thankyou_page_nav_title']; ?>
</label>
            <div><input type="text" name="thankyou_page_title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['thankyou_page_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" id="tpt" class="full" /></div>
          </div>
        </div>
      </div>

      <div class="btn apply_btn"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_apply_changes'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
 &raquo;</div>

            <input type="hidden" name="filename" id="filename" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
      <input type="hidden" name="folder_url" id="folder_url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
      <input type="hidden" name="folder_path" id="folder_path" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
  ...
  <div id="iframe_header">
    ...
    <h2><?php echo $this->_tpl_vars['L']['phrase_preview_page_c']; ?>
</h2>
    <div id="pages"></div>
    <div class="clear"></div>
  </div>
  ...
  <div id="footer">
    <div id="toggle_sidebar"><?php echo $this->_tpl_vars['L']['phrase_hide_sidebar']; ?>
</div>
    <?php if ($this->_tpl_vars['is_published'] == 'no'): ?>
      <span class="btn publish_btn"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['word_publish'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</span>
    <?php else: ?>
      <span class="btn publish_settings_btn"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_publish_settings'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</span>
    <?php endif; ?>
    <span class="btn save_btn"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['word_save'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</span>
    <span class="btn help_btn"><?php echo ((is_array($_tmp=$this->_tpl_vars['LANG']['word_help'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</span>
  </div>
  ...
  <div id="publish_form_dialog" style="display:none">
    ...
    <?php else: ?>
      <div class="margin_bottom_large">
        <?php echo $this->_tpl_vars['L']['text_publish_form_intro']; ?>
    ...
    <tr>
      <td class="medium_grey" width="120"><?php echo $this->_tpl_vars['L']['word_filename']; ?>
</td>
      <td>
        <input type="text" id="publish_filename" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> />.php
      </td>
    </tr>
    <tr>
      <td class="medium_grey"><?php echo $this->_tpl_vars['L']['phrase_folder_path']; ?>
</td>
      <td>
        <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td><input type="text" id="publish_folder_path" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> /></td>
          <?php if ($this->_tpl_vars['module_settings']['demo_mode'] != 'on'): ?>
          <td width="170">
...
"
    ...
    <tr>
      <td class="medium_grey"><?php echo $this->_tpl_vars['L']['phrase_folder_url']; ?>
</td>
      <td>
        <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td><input type="text" id="publish_folder_url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> /></td>
          <?php if ($this->_tpl_vars['module_settings']['demo_mode'] != 'on' && $this->_tpl_vars['allow_url_fopen']): ?>
            <td width="170"><input type="button" value="<?php echo $this->_tpl_vars['LANG']['phrase_confirm_folder_url_match']; ?>
"
        ...
        <input type="hidden" id="old_publish_folder_url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
      </td>
    </tr>
    </table>
  ...
  <div id="publish_settings_form_dialog" style="display:none">
    <div id="publish_settings_display">
      ...
      <?php else: ?>
        <div class="margin_bottom_large">
          <?php echo $this->_tpl_vars['L']['text_publish_settings_dialog_intro']; ?>
      ...
      <tr>
        ...
        <td>
          <input type="text" id="new_publish_filename" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> />.php
          <input type="hidden" id="old_publish_filename" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_filename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
        </td>
      </tr>
      <tr>
        <td class="medium_grey" valign="top"><?php echo $this->_tpl_vars['L']['phrase_folder_path']; ?>
</td>
        <td>
          <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td><input type="text" id="new_publish_folder_path" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> /></td>
            <?php if ($this->_tpl_vars['module_settings']['demo_mode'] != 'on'): ?>
            <td width="170">
              <input type="button" value="<?php echo $this->_tpl_vars['LANG']['phrase_test_folder_permissions']; ?>
"
          ...
          <input type="hidden" id="old_publish_folder_path" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
        </td>
      </tr>
      <tr>
        <td class="medium_grey" valign="top"><?php echo $this->_tpl_vars['L']['phrase_folder_url']; ?>
</td>
        <td>
          <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td><input type="text" id="new_publish_folder_url" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['published_folder_url'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" <?php if ($this->_tpl_vars['module_settings']['demo_mode'] == 'on'): ?>disabled<?php endif; ?> /></td>
            <?php if ($this->_tpl_vars['module_settings']['demo_mode'] != 'on' && $this->_tpl_vars['allow_url_fopen']): ?>
              <td width="170"><input type="button" value="<?php echo $this->_tpl_vars['LANG']['phrase_confirm_folder_url_match']; ?>
"
...
" />
    ...
    <div id="publish_settings_response" style="display:none">
      <div class="margin_bottom"><?php echo $this->_tpl_vars['L']['notify_form_republished']; ?>
</div>
        <input type="text" class="large_textbox" value="" />
        <a href="" target="_blank" id="publish_dialog_open_form_link"><?php echo $this->_tpl_vars['L']['phrase_open_form_in_new_window']; ?>
</a>
    </div>
  </div>
