<?php /* Smarty version 2.6.18, created on 2017-05-08 14:15:07
         compiled from /opt/lampp/htdocs/www/formtools/themes/default/../../modules/custom_fields/templates/tab_add_validation_rule.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', '/opt/lampp/htdocs/www/formtools/themes/default/../../modules/custom_fields/templates/tab_add_validation_rule.tpl', 1, false),array('modifier', 'escape', '/opt/lampp/htdocs/www/formtools/themes/default/../../modules/custom_fields/templates/tab_add_validation_rule.tpl', 58, false),array('function', 'rsv_rules', '/opt/lampp/htdocs/www/formtools/themes/default/../../modules/custom_fields/templates/tab_add_validation_rule.tpl', 16, false),)), $this); ?>
  <div class="subtitle underline margin_top_large"><?php echo ((is_array($_tmp=$this->_tpl_vars['L']['phrase_add_validation_rule'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
</div>
...
" />
    ...
    <tr>
      ...
      <td><?php echo smarty_function_rsv_rules(array('name_id' => 'rsv_rule','omit' => $this->_tpl_vars['existing_validation_rules']), $this);?>
</td>
    </tr>
    <tr>
